                    ...
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="hidden" id="medicineshopmaster-latitude" class="latitude form-control" name="MedicineShopMaster[latitude]">
                            </div>
                            <div class="col-md-6">
                                <!--                                <label class="control-label col-md-3">Long(Second one)</label>-->
                                <input type="hidden" id="medicineshopmaster-longitude" class="longitude form-control" name="MedicineShopMaster[longitude]">
                            </div>
                        </div>
        ...
        <div class="form-body">
            <div class="form-group">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input class="file" id="featured-img" type="file" name="MedicineShopMaster[image]"><br>
                    </div>
                </div>
                <div class="help-block"></div>
            </div>
            ...
            <div class="col-md-6">
                <div class="input-group">
                    <div id="radioBtn" class="btn-group">
                        <a class="btn btn-primary btn-sm active" data-toggle="medicineshopmaster-status" data-title="1">Active</a>
                        <a class="btn btn-primary btn-sm notActive" data-toggle="medicineshopmaster-status" data-title="0">Inactive</a>
                    </div>
                    <input type="hidden" name="MedicineShopMaster[status]" id="medicineshopmaster-status">
                </div>
