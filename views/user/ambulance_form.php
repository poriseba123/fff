    ...
    <div class="portlet-body form">
                    ...
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="hidden" id="ambulancemaster-latitude" class="latitude form-control" name="AmbulanceMaster[latitude]">
                            </div>
                            <div class="col-md-6">
                                <!--                                <label class="control-label col-md-3">Long(Second one)</label>-->
                                <input type="hidden" id="ambulancemaster-longitude" class="longitude form-control" name="AmbulanceMaster[longitude]">
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <div id="radioBtn" class="btn-group">
                            <a class="btn btn-primary btn-sm active" data-toggle="ambulancemaster-all_time" data-title="1">YES</a>
                            <a class="btn btn-primary btn-sm notActive" data-toggle="ambulancemaster-all_time" data-title="0">NO</a>
                        </div>
                        <input type="hidden" name="AmbulanceMaster[all_time]" id="ambulancemaster-all_time">
                    </div>
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <div id="radioBtn" class="btn-group">
                            <a class="btn btn-primary btn-sm active" data-toggle="ambulancemaster-ac" data-title="1">YES</a>
                            <a class="btn btn-primary btn-sm notActive" data-toggle="ambulancemaster-ac" data-title="0">NO</a>
                        </div>
                        <input type="hidden" name="AmbulanceMaster[ac]" id="ambulancemaster-ac">
                    </div>
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <div id="radioBtn" class="btn-group">
                            <a class="btn btn-primary btn-sm active" data-toggle="ambulancemaster-oxygen" data-title="1">YES</a>
                            <a class="btn btn-primary btn-sm notActive" data-toggle="ambulancemaster-oxygen" data-title="0">NO</a>
                        </div>
                        <input type="hidden" name="AmbulanceMaster[oxygen]" id="ambulancemaster-oxygen">
                    </div>
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <div id="radioBtn" class="btn-group">
                            <a class="btn btn-primary btn-sm active" data-toggle="ambulancemaster-lifesupport" data-title="1">YES</a>
                            <a class="btn btn-primary btn-sm notActive" data-toggle="ambulancemaster-lifesupport" data-title="0">NO</a>
                        </div>
                        <input type="hidden" name="AmbulanceMaster[lifesupport]" id="ambulancemaster-lifesupport">
                    </div>
        ...
        <div class="form-body">
            <div class="form-group">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input class="file" id="featured-img" type="file" name="AmbulanceMaster[image]"><br>
                    </div>
                </div>
                <div class="help-block"></div>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="input-group">
                    <div id="radioBtn" class="btn-group">
                        <a class="btn btn-primary btn-sm active" data-toggle="ambulancemaster-status" data-title="1">Active</a>
                        <a class="btn btn-primary btn-sm notActive" data-toggle="ambulancemaster-status" data-title="0">Inactive</a>
                    </div>
                    <input type="hidden" name="AmbulanceMaster[status]" id="ambulancemaster-status">
                </div>
