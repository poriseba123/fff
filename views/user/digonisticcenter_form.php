    ...
    <div class="portlet-body form">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <input type="hidden" id="diagnosticcentre-latitude" class="latitude form-control" name="DiagnosticCentre[latitude]">
                            </div>
                            <div class="col-md-6">
                                <input type="hidden" id="diagnosticcentre-longitude" class="longitude form-control" name="DiagnosticCentre[longitude]">
                            </div>
                        </div>
        ...
        <div class="form-body">
            <div class="form-group">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input class="file" id="featured-img" type="file" name="DiagnosticCentre[image]"><br>
                    </div>
                </div>
                <div class="help-block"></div>
            </div>
            ...
            <div class="col-md-6">
                <div class="input-group">
                    <div id="radioBtn" class="btn-group">
                        <a class="btn btn-primary btn-sm active" data-toggle="diagnosticcentre-e_report" data-title="1">YES</a>
                        <a class="btn btn-primary btn-sm notActive" data-toggle="diagnosticcentre-e_report" data-title="0">NO</a>
                    </div>
                    <input type="hidden" name="DiagnosticCentre[e_report]" id="diagnosticcentre-e_report">
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="input-group">
                    <div id="radioBtn" class="btn-group">
                        <a class="btn btn-primary btn-sm active" data-toggle="diagnosticcentre-home_collection" data-title="1">YES</a>
                        <a class="btn btn-primary btn-sm notActive" data-toggle="diagnosticcentre-home_collection" data-title="0">NO</a>
                    </div>
                    <input type="hidden" name="DiagnosticCentre[home_collection]" id="diagnosticcentre-home_collection">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="input-group">
                    <div id="radioBtn" class="btn-group">
                        <a class="btn btn-primary btn-sm active" data-toggle="diagnosticcentre-status" data-title="1">Active</a>
                        <a class="btn btn-primary btn-sm notActive" data-toggle="diagnosticcentre-status" data-title="0">Inactive</a>
                    </div>
                    <input type="hidden" name="DiagnosticCentre[status]" id="diagnosticcentre-status">
                </div>
            </div>
        </div>
