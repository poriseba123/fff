                                    ...
                                    <div class="cmn-upper-pad">
                                        <div class="row">
                                            <div class="col-md-10 col-md-offset-2">
                                                ...
                                                <p>Le enviaremos su contraseña al email registrado en tu cuenta.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-10 col-md-offset-2">
                                                <p>Si he olvidado tu contraseña, haga click en este <a href="#">enlace</a> para recibir una nueva.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
