                                ...
                                <div class="col-md-10 col-md-offset-1 col-sm-12">
                                    <div class="cmn-upper-pad">
                                        <div class="alert alert-info text-center" role="alert">
                                            <strong>No se puede publicar un anuncio hasta que se apruebe su vehículo</strong>
                                        </div>
                                        <div id="addvehiclecontainer" class="">
                                            <form class="form form-horizontal userVehicleRequestform" id="userVehicleEditRequest" role="form" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row form-group text-center">
                                                    <a href="<?= Yii::$app->urlManager->createUrl("vehicle/addvehicle") ?>" class="btn all-default-btn btn-margin-cust">CANCELAR</a>
                                                    <button class="btn all-default-btn btn-margin-cust" type="submit">guardar cambios</button>
                                                </div>
                                            </form>  
                                        </div>
                                    </div>
