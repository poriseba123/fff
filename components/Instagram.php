...
class Instagram extends Component {
    ...
    public function __construct()
    {
        ...
        $apiKey= Settings::find()->where(['slug'=>'instagram_client_id'])->one()->value;
        $apiSecret=Settings::find()->where(['slug'=>'instagram_client_secret'])->one()->value;
//        $apiKey= '16e1e7318f8342df8955589ff19e1672';
//        $apiSecret='194cbadd52a84f81aa54f7c3d84d81bd';
    //    $apiCallback=  \yii\helpers\Url::base(true)."/instagram-success";
//        $apiCallback=  \yii\helpers\Url::base(true)."/instagram-check-complete";
        $apiCallback=  $this->_redirectIns;
    ...
    {  
        $this->setApiCallback($this->_redirectIns);
