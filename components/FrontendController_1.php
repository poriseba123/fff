...
class FrontendController extends Controller {
    ...
    public function span_accent($wordz) { $wordz = str_replace( "Á","&Aacute;",$wordz); $wordz = str_replace( "É","&Eacute;",$wordz); $wordz = str_replace( "Í","&Iacute;",$wordz); $wordz = str_replace( "Ó","&Oacute;",$wordz); $wordz = str_replace( "Ú","&Uacute;",$wordz); $wordz = str_replace( "Ñ","&Ntilde;",$wordz); $wordz = str_replace( "Ü","&Uuml;",$wordz); $wordz = str_replace( "á","&aacute;",$wordz); $wordz = str_replace( "é","&eacute;",$wordz); $wordz = str_replace( "í","&iacute;",$wordz); $wordz = str_replace( "ó","&oacute;",$wordz); $wordz = str_replace( "ú","&uacute;",$wordz); $wordz = str_replace( "ñ","&ntilde;",$wordz); $wordz = str_replace( "ü","&uuml;",$wordz); $wordz = str_replace( "¿","&iquest;",$wordz); $wordz = str_replace( "¡","&iexcl;",$wordz); $wordz = str_replace( "€","&euro;",$wordz); $wordz = str_replace( "«","&laquo;",$wordz); $wordz = str_replace( "»","&raquo;",$wordz); $wordz = str_replace( "‹","&lsaquo;",$wordz); $wordz = str_replace( "›","&rsaquo;",$wordz); return $wordz; }
...
//       return $date1.' '.$date2;
        ...
        if ($intervalDiff->y == 0) {
            if ($intervalDiff->m == 0) {
                if ($intervalDiff->d == 0) {
                    ...
                    if ($intervalDiff->d == 1) {
                        ...
                        $interval = $intervalDiff->d . " " . yii::t('app', 'hace dÃ­as');
                    }
                }
            } else {
                if ($intervalDiff->m == 1) {
            ...
            if ($intervalDiff->y == 1) {
                $interval = $intervalDiff->y . " " .  'aÃ±os';//years
            } else {
                $interval = $intervalDiff->y . " " .  'aÃ±os';
            }
        }
