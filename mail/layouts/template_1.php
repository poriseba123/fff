                    ...
                    <td align="center" valign="top" style="border-collapse:collapse">
                        <table border="0" cellpadding="0" cellspacing="0" width="560" style="background:#ffffff;border:1px solid #cccccc;margin-top:10px" bgcolor="#FFFFFF">
                            <tbody>
                                <tr>
                                    <td align="center" valign="top" style="border-collapse:collapse">
                                        <table border="0" cellpadding="23" cellspacing="0" width="100%" style="background:#ffffff;border-bottom-width:0" bgcolor="#FFFFFF">
                                            <tbody>
                                                <tr>
                                                    <td style="border-collapse:collapse;text-align:center;vertical-align:top ;background-color: #4a4846;" align="left" valign="top">
                                ...
                                <tr>
                                    <td>
                                        <table border="0" cellpadding="10" cellspacing="0" width="560" style="border-collapse:collapse">
                                            <tbody>
                                                <tr>
                                                    <td valign="top" style="border-collapse:collapse">
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="middle" style="border-collapse:collapse;color:#999;display:block;font-family:Arial;font-size:10px;font-weight:normal;line-height:130%">
                                                                        <div>
                                                                            ...
                                                                            <font>
                                                                                <font>
                                                                                    You obtain the service E-mail this because of your membership in <?= $this->context->getProjectName() ?>.
                                                                                </font>
                                                                            ...
                                                                            <span style="color:inherit;text-decoration:none">
                                                                                <font>
                                                                                    <font>
                                                                                        <address><p class="copyright"><?= date('Y'); ?> &copy;  <?= $this->context->getProjectName() ?>. All rights reserved.</p></address>
                                                                                    </font>
                                                                                </font>
                                                                            </span>
                                                                        </div>
