                    ...
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="gymcenter-latitude" class="latitude form-control" name="GymCenter[latitude]">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3">Long(Second one)</label>
                                <input type="text" id="gymcenter-longitude" class="longitude form-control" name="GymCenter[longitude]">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class='input-group date timepicker'>
                                    <input type="text" id="gymmaster-open_time" class="form-control" name="GymCenter[open_time]">
                            ...
                            <div class="col-md-6">
                                <div class='input-group date timepicker'>
                                    <input type="text" id="gymmaster-close_time" class="form-control" name="GymCenter[close_time]">
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                </div>
