                ...
                <div class="col-md-6">
                    ...
                    echo $form->field($model, 'country_id')->widget(Select2::classname(), [
                        ...
                        $.post("' . Url::to(['dashboard/getstates']) . '?id=' . '"+$(this).val(),function(data){
                          $("select#gymcenter-state_id").html(data);
                        });'],
                        'pluginOptions' => [
                            'allowClear' => true,
                            'tags' => true,
                ...
                <div class="col-md-6">
                    ...
                    echo $form->field($model, 'state_id')->widget(Select2::classname(), [
                        ...
                        'options' => ['placeholder' => 'Search State', 'multiple' => false, 'onchange' =>
                         ...
                         $("select#gymcenter-district_id").html(data);
                        });'],
                        'pluginOptions' => [
                            'allowClear' => true,
                            'tags' => true,
                ...
                <div class="col-md-6">
                    ...
                    echo $form->field($model, 'district_id')->widget(Select2::classname(), [
                        ...
                        'options' => ['placeholder' => 'Search District', 'multiple' => false, 'onchange' =>
                         ...
                         $("select#gymcenter-city_id").html(data);
                        });'],
                        'pluginOptions' => [
                            'allowClear' => true,
                            'tags' => true,
                    ...
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="gymcenter-latitude" class="latitude form-control" name="GymCenter[latitude]" value="<?= $model->latitude ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3">Long(Second one)</label>
                                <input type="text" id="gymcenter-longitude" class="longitude form-control" name="GymCenter[longitude]" value="<?= $model->longitude ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class='input-group date timepicker'>
                                    <input type="text" id="gymcenter-open_time" class="form-control" name="GymCenter[open_time]" value="<?= $model->open_time ?>">
                            ...
                            <div class="col-md-6">
                                <div class='input-group date timepicker'>
                                    <input type="text" id="gymcenter-close_time" class="form-control" name="GymCenter[close_time]" value="<?= $model->close_time ?>">
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group text-center" id='preview-img-holder'>
                        <img src="<?= Yii::$app->request->baseUrl . '\uploads\gymcenter\thumbnail\\' . $model->image ?>" class="thumb-image" style="height: 80px;">
                    </div>
                </div>
        ...
        <div class="form-actions">
            <div class="row">
                <div class="col-md-offset-3 col-md-6">
                    ...
                    <a href="<?php echo Url::to(['gymcenter/index']); ?>" class="btn default">Back</a>
                </div>
            </div>
        </div>
        <?php ActiveForm::end() ?>
