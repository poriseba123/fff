                    ...
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="orphanehome-latitude" class="latitude form-control" name="Orphanehome[latitude]">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3">Long(Second one)</label>
                                <input type="text" id="orphanehome-longitude" class="longitude form-control" name="Orphanehome[longitude]">
                            </div>
                        </div>
