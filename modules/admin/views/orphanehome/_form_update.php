...
<div class="portlet light bordered form-fit">
    ...
    <div class="portlet-body form">
        ...
        <div class="form-body">
            <div class="form-group">
                <label class="control-label col-md-3">Only for<span class="required">*</span></label>
                <div class="col-md-6">
                    <?php
                    $listData = array('0' => 'Male', '1' => 'Female', '2' => 'Both');
                    echo $form->field($model, 'sex_flag')->widget(Select2::classname(), [
                        'data' => $listData,
                        'options' => ['placeholder' => 'Search type', 'multiple' => false],
                        'pluginOptions' => [
                            'allowClear' => true
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    $.post("' . Url::to(['dashboard/getstates']) . '?id=' . '"+$(this).val(),function(data){
                      $("select#orphanehome-state_id").html(data);
                    });'],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],
                ...
                <div class="col-md-6">
                    ...
                    echo $form->field($model, 'state_id')->widget(Select2::classname(), [
                        ...
                        'options' => ['placeholder' => 'Search State', 'multiple' => false, 'onchange' =>
                         ...
                         $("select#orphanehome-district_id").html(data);
                        });'],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],
                ...
                <div class="col-md-6">
                    ...
                    echo $form->field($model, 'district_id')->widget(Select2::classname(), [
                        ...
                        'options' => ['placeholder' => 'Search District', 'multiple' => false, 'onchange' =>
                         ...
                         $("select#orphanehome-city_id").html(data);
                        });'],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],
                    ...
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="orphanehome-latitude" class="latitude form-control" name="Orphanehome[latitude]" value="<?= $model->latitude ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3">Long(Second one)</label>
                                <input type="text" id="orphanehome-longitude" class="longitude form-control" name="Orphanehome[longitude]" value="<?= $model->longitude ?>">
                            </div>
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group text-center" id='preview-img-holder'>
                        <img src="<?= Yii::$app->request->baseUrl . '\uploads\orphanehome\thumbnail\\' . $model->image ?>" class="thumb-image" style="height: 80px;">
                    </div>
                </div>
