    ...
    <div class="portlet-body form">
		...
		<div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <?php
                    $state_list = \app\models\States::find()->all();
                    $listData = ArrayHelper::map($state_list, 'id', 'name');
                    echo $form->field($model, 'state_id')->dropDownList($listData, ['prompt' => 'Select'])->label(false);
                    ?>
                </div>
            </div>
        </div>
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="hidden" name="district_id" value="<?= $model->id ?>">
