                    ...
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="bloodbankmaster-latitude" class="latitude form-control" name="BloodBankMaster[latitude]">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3">Long(Second one)</label>
                                <input type="text" id="bloodbankmaster-longitude" class="longitude form-control" name="BloodBankMaster[longitude]">
                            </div>
                        </div>
