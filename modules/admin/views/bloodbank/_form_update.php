                    ...
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="bloodbankmaster-latitude" class="latitude form-control" name="BloodBankMaster[latitude]" value="<?= $model->latitude ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3">Long(Second one)</label>
                                <input type="text" id="bloodbankmaster-longitude" class="longitude form-control" name="BloodBankMaster[longitude]" value="<?= $model->longitude ?>">
                            </div>
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group text-center" id='preview-img-holder'>
                        <img src="<?= Yii::$app->request->baseUrl . '\uploads\bloodbank\thumbnail\\' . $model->image ?>" class="thumb-image" style="height: 80px;">
                    </div>
                </div>
