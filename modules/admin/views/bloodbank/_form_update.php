    ...
    <div class="portlet-body form">
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="hidden" name="blood_bank_id" value="<?=$model->id?>">
...
<?= $form->field($model, 'address')->textArea(['class' => 'form-control', 'rows' => '2'])->label(false); ?>
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="hidden" id="bloodbankmaster-latitude" class="form-control" name="BloodBankMaster[latitude]" value="<?=$model->latitude?>">
                    <input type="hidden" id="bloodbankmaster-longitude" class="form-control" name="BloodBankMaster[longitude]" value="<?=$model->longitude?>">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class='input-group date timepicker'>
                                    <input type="text" id="bloodbankmaster-open_time" class="form-control" name="BloodBankMaster[open_time]" value="<?=$model->open_time?>">
                            ...
                            <div class="col-md-6">
                                <div class='input-group date timepicker'>
                                    <input type="text" id="bloodbankmaster-close_time" class="form-control" name="BloodBankMaster[close_time]" value="<?=$model->close_time?>">
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                </div>
    ...
    $(function () {
        $('.timepicker').datetimepicker({
            format: 'LT'
                ...
                setTimeout(function(){$('#bloodbankmaster-state_id').val(state_id);},'1000');
                setTimeout(function(){$('#bloodbankmaster-state_id').trigger('onchange');},'2000');
                setTimeout(function(){$('#bloodbankmaster-city_id').val(city_id);},'3000');
    });
     var global_val = 1;
