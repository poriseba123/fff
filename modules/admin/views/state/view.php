...
$this->title = 'Manage State Details';
...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green-haze bold uppercase">State Details</span>
        </div>
    </div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                <a href="<?php echo Url::toRoute(['state/update', 'id' => $model->id]); ?>" class="btn green">Edit</a>
