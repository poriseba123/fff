                    ...
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="medicineshopmaster-latitude" class="latitude form-control" name="MedicineShopMaster[latitude]">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3">Long(Second one)</label>
                                <input type="text" id="medicineshopmaster-longitude" class="longitude form-control" name="MedicineShopMaster[longitude]">
                            </div>
                        </div>
