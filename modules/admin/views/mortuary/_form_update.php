                    ...
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="mortuarymaster-latitude" class="latitude form-control" name="MortuaryMaster[latitude]" value="<?= $model->latitude ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3">Long(Second one)</label>
                                <input type="text" id="mortuarymaster-longitude" class="longitude form-control" name="MortuaryMaster[longitude]" value="<?= $model->longitude ?>">
                            </div>
                        </div>
