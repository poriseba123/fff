    ...
    <div class="portlet-body form">
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="hidden" name="mortuary_id" value="<?= $model->id ?>">
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="hidden" id="mortuarymaster-latitude" class="form-control" name="MortuaryMaster[latitude]" value="<?= $model->latitude ?>">
                    <input type="hidden" id="mortuarymaster-longitude" class="form-control" name="MortuaryMaster[longitude]" value="<?= $model->longitude ?>">
...
<script>
    $(function () {
	 ...
	 city_id="<?php echo $model->city_id?>";
		function fireagain(){
			setTimeout(function(){console.log('now'),$('#mortuarymaster-district_id').val(district_id).then($('#mortuarymaster-district_id').trigger('onchange'));},'2000');
		}
		$(function () {
			$('.timepicker').datetimepicker({
				format: 'LT'
			...
			$('#mortuarymaster-country_id').trigger('onchange');
			setTimeout(function(){$('#mortuarymaster-state_id').val(state_id).then($('#mortuarymaster-state_id').trigger('onchange'),fireagain())},'1500');
		});
    });
    var global_val = 1;
