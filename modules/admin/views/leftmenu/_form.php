    ...
    <div class="portlet-body form">
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <?= $form->field($model, 'page_name')->textInput(['class' => 'form-control'])->label(false); ?>
                </div>
            </div>
        </div>
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <?= $form->field($model, 'link')->textInput(['class' => 'form-control'])->label(false); ?>
                </div>
            </div>
        </div>
        ...
        <div class="form-actions">
            <div class="row">
                <div class="col-md-offset-3 col-md-6">
                    ...
                    <a href="<?php echo Url::to(['leftmenu/index']); ?>" class="btn default">Back</a>
                </div>
            </div>
        </div>
        <?php ActiveForm::end() ?>
