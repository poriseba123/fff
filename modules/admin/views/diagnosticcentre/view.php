...
$this->title = 'Diagnostic Centre Details';
...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green-haze bold uppercase">Diagnosticcentre Details</span>
        </div>
    </div>
        ...
        <form class="form-horizontal" role="form">
            <div class="form-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="form-group col-md-9" id='preview-img-holder'>
                                <img src="<?= (isset($model->image) && $model->image != '') ? Yii::$app->request->baseUrl . '\uploads\diagnostic_centre\thumbnail\\' . $model->image : Yii::$app->request->baseUrl . '\uploads\noimage\noimg.jpg' ?>" class="thumb-image img-thumbnail" style="height: 80px;">
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <p class="form-control-static"> <?= (isset($model->website) && $model->website != '') ? $model->website : "Not Set"; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-3">Medical Test:</label>
                            <?php
                            $test_name = array();
                            $medical_tests_lists = \app\models\MedicalTests::find()->all();
                            $listData = ArrayHelper::map($medical_tests_lists, 'id', 'name');
                            if (isset($model->medical_tests) && $model->medical_tests != '') {
                                $arr = explode(",", $model->medical_tests);
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <p class="form-control-static"> <?= (isset($model->others) && $model->others != '') ? $model->others : "Not Set"; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-3">E-report:</label>
                            <div class="col-md-9">
                                <p class="form-control-static"> <?= (isset($model->e_report) && $model->e_report == '1') ? 'Yes' : "No"; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-3">Home Collection:</label>
                            <div class="col-md-9">
                                <p class="form-control-static"> <?= (isset($model->home_collection) && $model->home_collection == '1') ? 'Yes' : "No"; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                <a href="<?php echo Url::toRoute(['diagnosticcentre/update', 'id' => $model->id]); ?>" class="btn green">Edit</a>
