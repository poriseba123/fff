       ...
       <div class="form-body">
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="hidden" id="gymmaster-latitude" class="form-control" name="GymMaster[latitude]">
                    <input type="hidden" id="gymmaster-longitude" class="form-control" name="GymMaster[longitude]">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class='input-group date timepicker'>
                                    <input type="text" id="gymmaster-open_time" class="form-control" name="GymMaster[open_time]">
                            ...
                            <div class="col-md-6">
                                <div class='input-group date timepicker'>
                                    <input type="text" id="gymmaster-close_time" class="form-control" name="GymMaster[close_time]">
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                </div>
        ...
        <div class="form-actions">
            <div class="row">
                <div class="col-md-offset-3 col-md-6">
                    ...
                    <a href="<?php echo Url::to(['gym/index']); ?>" class="btn default">Back</a>
                </div>
            </div>
        </div>
        <?php ActiveForm::end() ?>
