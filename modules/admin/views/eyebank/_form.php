	...
	<div class="form-body">
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="hidden" id="eyebankmaster-latitude" class="form-control" name="EyeBankMaster[latitude]">
                    <input type="hidden" id="eyebankmaster-longitude" class="form-control" name="EyeBankMaster[longitude]">
