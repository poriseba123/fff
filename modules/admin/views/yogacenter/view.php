...
$this->title = 'Manage Yoga Details';
...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green-haze bold uppercase">Yoga Details</span>
        </div>
    </div>
        ...
        <form class="form-horizontal" role="form">
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <p class="form-control-static"> <?= (isset($model->establishment_date) && $model->establishment_date != '') ? $model->establishment_date : "Not Set"; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="form-group col-md-9" id='preview-img-holder'>
                                <img src="<?= (isset($model->image) && $model->image != '') ? Yii::$app->request->baseUrl . '\uploads\yogacenter\thumbnail\\' . $model->image : Yii::$app->request->baseUrl . '\uploads\noimage\noimg.jpg' ?>" class="thumb-image img-thumbnail" style="height: 80px;">
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-3">Trainer Available:</label>
                            <div class="col-md-9">
                                <p class="form-control-static"> <?php
                                    if (isset($model->trainer_sex)) {
                                        if ($model->trainer_sex == '1') {
                                            echo "Male";
                                        } else if ($model->trainer_sex == '2') {
                                            echo "Female";
                                        } else {
                                            echo "Both";
                                        }
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-3">Allowed Sex Type:</label>
                            <div class="col-md-9">
                                <p class="form-control-static"> <?php
                                    if (isset($model->sexof_traines)) {
                                        if ($model->sexof_traines == '1') {
                                            echo "Male";
                                        } else if ($model->sexof_traines == '2') {
                                            echo "Female";
                                        } else {
                                            echo "Both";
                                        }
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                <a href="<?php echo Url::toRoute(['yogacenter/update', 'id' => $model->id]); ?>" class="btn green">Edit</a>
