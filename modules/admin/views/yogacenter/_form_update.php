                ...
                <div class="col-md-6">
                    ...
                    echo $form->field($model, 'country_id')->widget(Select2::classname(), [
                        ...
                        $.post("' . Url::to(['dashboard/getstates']) . '?id=' . '"+$(this).val(),function(data){
                          $("select#yogacenter-state_id").html(data);
                        });'],
                        'pluginOptions' => [
                            'allowClear' => true,
                            'tags' => true,
                ...
                <div class="col-md-6">
                    ...
                    echo $form->field($model, 'state_id')->widget(Select2::classname(), [
                        ...
                        'options' => ['placeholder' => 'Search State', 'multiple' => false, 'onchange' =>
                         ...
                         $("select#yogacenter-district_id").html(data);
                        });'],
                        'pluginOptions' => [
                            'allowClear' => true,
                            'tags' => true,
                ...
                <div class="col-md-6">
                    ...
                    echo $form->field($model, 'district_id')->widget(Select2::classname(), [
                        ...
                        'options' => ['placeholder' => 'Search District', 'multiple' => false, 'onchange' =>
                         ...
                         $("select#yogacenter-city_id").html(data);
                        });'],
                        'pluginOptions' => [
                            'allowClear' => true,
                            'tags' => true,
                    ...
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="yogacenter-latitude" class="latitude form-control" name="YogaCenter[latitude]" value="<?= $model->latitude ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3">Long(Second one)</label>
                                <input type="text" id="yogacenter-longitude" class="longitude form-control" name="YogaCenter[longitude]" value="<?= $model->longitude ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class='input-group date timepicker'>
                                    <input type="text" id="yogacenter-open_time" class="form-control" name="YogaCenter[open_time]" value="<?= $model->open_time ?>">
                            ...
                            <div class="col-md-6">
                                <div class='input-group date timepicker'>
                                    <input type="text" id="yogacenter-close_time" class="form-control" name="YogaCenter[close_time]" value="<?= $model->close_time ?>">
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                </div>
...
//                    $city_list = \app\models\Cities::find()->where(["id" => 0])->all();
                    ...
                    echo $form->field($model, 'close_day')->widget(Select2::classname(), [
                        'data' => $listData,
                        'options' => ['placeholder' => 'Search Days', 'multiple' => false],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],
                    ])->label(false);
        ...
        <div class="form-body">
            <div class="form-group">
                <label class="control-label col-md-3">Trainer Available <span class="required">*</span></label>
                <div class="col-md-6">
                    <div class="radio-list">                        
                        <label class="radio-inline">
                            <?php
                            echo $form->field($model, 'trainer_sex')->radioList(['1' => 'Male', '0' => 'Female', '2' => 'Both'])->label(false);
                            ?>
                        </label>
                    </div>
                </div>
        ...
        <div class="form-body">
            <div class="form-group">
                <label class="control-label col-md-3">Allowed Sex Type <span class="required">*</span></label>
                <div class="col-md-6">
                    <div class="radio-list">                        
                        <label class="radio-inline">
                            <?php
                            echo $form->field($model, 'sexof_traines')->radioList(['1' => 'Male', '2' => 'Female', '3' => 'Both'])->label(false);
                            ?>
                        </label>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group text-center" id='preview-img-holder'>
                        <img src="<?= Yii::$app->request->baseUrl . '\uploads\yogacenter\thumbnail\\' . $model->image ?>" class="thumb-image" style="height: 80px;">
                    </div>
                </div>
        ...
        <div class="form-actions">
            <div class="row">
                <div class="col-md-offset-3 col-md-6">
                    ...
                    <a href="<?php echo Url::to(['yogacenter/index']); ?>" class="btn default">Back</a>
                </div>
            </div>
        </div>
        <?php ActiveForm::end() ?>
