...
$this->title = 'View Cancel & Refund requests';
...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green-haze bold uppercase">View Cancel & Refund Request</span>
        </div>
    </div>
                                ...
                                <p class="form-control-static">
                                    ...
                                    if(strtotime($model->request_time)<strtotime($model->userDetailsTripLocationStart->departure_datetime)){
                                       if($this->context->getTimeDifferenceinHour($model->request_time,$model->userDetailsTripLocationStart->departure_datetime)>24){
                                           echo $model->total_price;
                                       }else{
                                           if($this->context->getTimeDifferenceinHour($model->request_time,$model->userDetailsTripLocationStart->departure_datetime)>3){
...
?>
            ...
            <div class="form-actions text-right">
                <a href="<?= Url::to(['refund/']); ?>" class="btn default">Back</a>
            </div>
        </form>
        <!-- END FORM-->
    </div>
