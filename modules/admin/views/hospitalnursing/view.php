...
$this->title = 'Hospital Nursing home Details';
...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green-haze bold uppercase">Hospital Nursing home Details</span>
        </div>
    </div>
        ...
        <form class="form-horizontal" role="form">
            <div class="form-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="form-group col-md-9" id='preview-img-holder'>
                                <img src="<?= (isset($model->image) && $model->image != '') ? Yii::$app->request->baseUrl . '\uploads\hospitalnursing\thumbnail\\' . $model->image : Yii::$app->request->baseUrl . '\uploads\noimage\noimg.jpg' ?>" class="thumb-image img-thumbnail" style="height: 80px;">
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            ?>
                            <div class="col-md-9">
                                <p class="form-control-static"> <?= (isset($test_name) && !empty($test_name)) ? implode(",", $test_name) : "Not Set"; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
               ...
               <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-3">Out door Time:</label>
                            <div class="col-md-9">
                                <?php
...
//print_r($day_master);
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-3">Emergency Word:</label>
                            <div class="col-md-9">
                                <p class="form-control-static"> <?= (isset($model->emergency) && $model->emergency == '1') ? 'Yes' : "No"; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <p class="form-control-static"> <?= (isset($model->ot) && $model->ot == '1') ? 'Yes' : "No"; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <p class="form-control-static"> <?= (isset($model->life_support) && $model->life_support == '1') ? 'Yes' : "No"; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-3">Ambulance Service:</label>
                            <div class="col-md-9">
                                <p class="form-control-static"> <?= (isset($model->ambulance) && $model->ambulance == '1') ? 'Yes' : "No"; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-3">Own medicine shop:</label>
                            <div class="col-md-9">
                                <p class="form-control-static"> <?= (isset($model->medicine_shop) && $model->medicine_shop == '1') ? 'Yes' : "No"; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-3">Payment accepted other than cash:</label>
                            <div class="col-md-9">
                                <p class="form-control-static"> <?= (isset($model->payment_otherthancash) && $model->payment_otherthancash == '1') ? 'Yes' : "No"; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                <a href="<?php echo Url::toRoute(['hospitalnursing/update', 'id' => $model->id]); ?>" class="btn green">Edit</a>
