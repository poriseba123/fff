                    ...
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="AyaMaster-latitude" class="latitude form-control" name="AyaMaster[latitude]" value="<?= $model->latitude ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-md-3">Long(Second one)</label>
                                <input type="text" id="AyaMaster-longitude" class="longitude form-control" name="AyaMaster[longitude]" value="<?= $model->longitude ?>">
                            </div>
                        </div>
...
if ($model->isNewRecord) {
    ?>
        ...
        currentlong = 78.9629;
<?php } else { ?>
        currentlat = '<?= ($model->latitude != '') ? $model->latitude : 20.5937; ?>';               //// india lat and long
        currentlong = '<?= ($model->longitude != '') ? $model->longitude : 78.9629; ?>';
