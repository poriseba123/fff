...
class ClaimrefundController extends AdminController {
        ...
        $gridColumns = [
            ...
            [
                ...
                'urlCreator' => function($action, $model, $key, $index) {
                    switch ($action) {
                        case "view":
                            return Url::to(['claimrefund/view', 'id' => $model->id]);
                            break;
                        ...
                        'buttons' => [
                            'edit' => function ($url, $model) {
                                return Html::a('<i class="fa fa-pencil-square-o" aria-hidden="true"></i>', Url::to(['claimrefund/update', 'id' => $model->id]), [
                    ...
                    public function actionIndex() {
                        $this->view->title = $this->getProjectName() . ": Claim & Refund Management";

                        $model = new \app\modules\admin\models\BookingMaster;
                        $dataProvider = $model->claim_search(Yii::$app->request->queryParams);
