...
class DiagnosticcentreController extends AdminController {
        ...
        $gridColumns = [
            ...
            [
                ...
                'urlCreator' => function($action, $model, $key, $index) {
                    switch ($action) {
                        case "view":
                            return Url::to(['diagnosticcentre/view', 'id' => $model->id]);
                            break;
                        case "update":
                            return Url::to(['diagnosticcentre/update', 'id' => $model->id]);
                            break;
                        case "delete":
                            return Url::to(['diagnosticcentre/delete', 'id' => $model->id]);
                            break;
                    }
                },
    ...
    public function actionIndex() {
        $searchModel = new DiagnosticCentre;
